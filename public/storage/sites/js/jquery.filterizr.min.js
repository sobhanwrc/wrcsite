    ...
    r.prototype = {
        ...
        init: function(t, r) {
            ...
            return e.options = {
                ...
                layout: "sameSize",
                setupControls: !0
            }, 0 === arguments.length && (r = e.options), 1 === arguments.length && "object" == typeof arguments[0] && (r = arguments[0]), r && e.setOptions(r), e.css({
                padding: 0,
                position: "relative"
        ...
        _calcItemPositions: function() {
            var t = this,
                ...
                a = 0,
                s = "undefined" != typeof e && e instanceof Array && e.hasOwnProperty("outerWidth") ? e[0].outerWidth() : 0,
                l = 0,
                f = 0,
                u = 0,
                c = 0,
            ...
            if ("horizontal" === t.options.layout)
                ...
                a = Math.ceil(e.length / o), n = a * ("undefined" != typeof e && e instanceof Array && e.hasOwnProperty("outerHeight") ? e[0].outerHeight() : 0)
            }
            return t.css("height", 698.969), _
        },
