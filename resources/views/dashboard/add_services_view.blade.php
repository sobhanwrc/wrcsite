      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" name="services_add_submit" id="services_add_submit" action="/services_add_submit" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="box-body">

                <div class="form-group {{ $errors->has('sofware_service') ? 'has-error' : '' }}">
                  <label for="exampleInputEmail1">Software Services:</label>
                  <textarea rows="7" class="form-control" id="sofware_service" name="sofware_service" ></textarea>
                ...
                <div class="form-group {{ $errors->has('mobile_application') ? 'has-error' : '' }}">
                  ...
                  <textarea rows="7" class="form-control" id="mobile_application" name="mobile_application" ></textarea>
                ...
                <div class="form-group {{ $errors->has('web_service') ? 'has-error' : '' }}">
                  ...
                  <textarea rows="7" class="form-control" id="web_service" name="web_service" ></textarea>
