      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" name="portfolio_form" id="portfolio_form" action="/portfolios_edit_submit/{{base64_encode($portfolio['id'])}}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('portfolio_type') ? 'has-error' : '' }}">
                  ...
                  <select class="form-control" name="portfolio_type" id="portfolio_type">
                    ...
                    @foreach($fetch_portfolio_type_details as $value)
                      <option value="{{$value['id']}}" <?php if($value['id']==$portfolio['portfolio_type']){?> selected <?php }?> >{{$value['portfolio_type']}}</option>
                    @endforeach
                ...
                <div class="form-group {{ $errors->has('portfolio_image') ? 'has-error' : '' }}">
                  ...
                  <img class="form-group" width="100" height="100" src="{{url('upload/banner/resize/'.$portfolio['portfolio_image'])}}">
                  <input class="form-group" type="hidden" name="portfolio_image" id="portfolio_image" value="{{$portfolio['portfolio_image']}}">
                </div>
              </div>
              <!-- /.box-body -->
