...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 04:53:34 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>WRC Admin | Dashboard</title>
  ...
  {!! Html::style('https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.2.3/jquery-confirm.min.css')!!}
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>WRC </b> Admin</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        {!!Html::image('storage/admin/dist/img/user2-160x160.jpg')!!}
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        {!!Html::image('storage/admin/dist/img/user3-128x128.jpg')!!}
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        {!!Html::image('storage/admin/dist/img/user4-128x128.jpg')!!}
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <?php if(empty(Auth::guard('admin')->user()->profile_image)){?>
                <img class="user-image" src="{{ url('/upload/profile_image/default.png')}}" alt="User profile picture">
              <?php }else{?>
                <img src="{{ url('/upload/profile_image/resize/' .Auth::guard('admin')->user()->profile_image)}}" class="user-image" alt="User Image">
              <?php } ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php }else{?>
                  <img src="{{ url('/upload/profile_image/resize/' .Auth::guard('admin')->user()->profile_image)}}" class="img-circle" alt="User Image">
                <?php } ?>
