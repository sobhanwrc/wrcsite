<!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; 2017 <a href="https://adminlte.io/">WRC Technologies Pvt Ltd</a>.</strong> All rights
    reserved.
  </footer>
...
{!!Html::script('storage/admin/datatables.net/js/jquery.dataTables.min.js')!!}

{!!Html::script('storage/admin/datatables.net-bs/js/dataTables.bootstrap.min.js')!!}
...
{!! Html::script('https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.2.3/jquery-confirm.min.js')!!}
...
<!-- AdminLTE App -->
<script src="storage/admin/dist/js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="storage/admin/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="storage/admin/dist/js/demo.js"></script>
<script>
  $(function () {
    $('#example1').DataTable({
      "scrollX": true
...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2017 04:54:12 GMT -->
</html>
